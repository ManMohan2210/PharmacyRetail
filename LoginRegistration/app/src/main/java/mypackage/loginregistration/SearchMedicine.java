...
public class SearchMedicine extends BaseActivty implements SearchView.OnSuggestionListener, OnItemClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDatabase = new SqliteHandler(SearchMedicine.this);
