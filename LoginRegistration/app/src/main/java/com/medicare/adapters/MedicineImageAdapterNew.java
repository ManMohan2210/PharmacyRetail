...
import com.medicare.models.PrescriptionData;
...
public class MedicineImageAdapterNew extends ArrayAdapter<PrescriptionData>{
        ...
        ArrayList<PrescriptionData> data=new ArrayList<PrescriptionData>();

        public MedicineImageAdapterNew(Context context, int layoutResourceId, ArrayList<PrescriptionData> data) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            PrescriptionData picture = data.get(position);
