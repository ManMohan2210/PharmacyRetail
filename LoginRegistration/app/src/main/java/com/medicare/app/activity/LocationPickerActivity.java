            ...
            public void onMapReady(MapboxMap map) {
                ...
                mapboxMap.setOnMarkerClickListener(new MapboxMap.OnMarkerClickListener() {
                    ...
                    public boolean onMarkerClick(@NonNull Marker marker) {
                        Toast.makeText(LocationPickerActivity.this, marker.getTitle(), Toast.LENGTH_LONG).show();
                        return true;
                    }
                });
            }
...
*//*
    ...
    private void trackUserLocationView(final MarkerView markerView) {
        final float circleDiameterSize = getResources().getDimension(R.dimen.margin_medium);
        ...
        mapboxMap.setOnCameraChangeListener(new MapboxMap.OnCameraChangeListener() {
            ...
            public void onCameraChange(CameraPosition position) {
                ...
                double longitude = position.target.getLongitude();//.getLongitude();
                double latitude = position.target.getLatitude();//
                ...
                if (view != null) {
                    View backgroundView = view.findViewById(R.id.intent_data_id);
                    if (pulseAnimation == null && distance < 0.5f * circleDiameterSize) {
                        pulseAnimation = AnimationUtils.loadAnimation(LocationPickerActivity.this, R.anim.down_from_top);
...
//        });
    ...
    private MarkerView createCustomUserMarker(LatLng markerPosition) {
        return mapboxMap.addMarker(new PulseMarkerViewOptions()
                .icon(IconFactory.getInstance(getApplicationContext()).fromResource(R.drawable.arrow))
                .position(markerPosition)
        );
    }

    private void createClearSelectionButton() {
//        clearDisplayViewButton = (ImageButton) findViewById(R.id.intent_data);
...
//        Button selectLocationButton = (Button) findViewById(R.id.intent_data);
...
//    }
    ...
    private void createDropPin() {
        ...
        dropPinView.setImageResource(R.drawable.ic_action_name);
        ...
        dropPinView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(LocationPickerActivity.this,"Location "+location,Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//
//                @Override
//                public int compare(GeocodingResponse o1, GeocodingResponse o2) {
//                    return 0;
//                }
//
//                @Override
...
//
//                @Override
//                public boolean areContentsTheSame(GeocodingResponse oldItem, GeocodingResponse newItem) {
//                    return false;
//                }
//
//                @Override
//                public boolean areItemsTheSame(GeocodingResponse item1, GeocodingResponse item2) {
//                    return false;
//                }
//
...
//    private static class PulseMarkerViewAdapter extends MapboxMap.MarkerViewAdapter<PulseMarkerViewAdapter> {
//
