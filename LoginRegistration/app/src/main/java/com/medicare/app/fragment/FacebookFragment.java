   ...
   // private TextView greeting;
    ...
    private FacebookCallback<Sharer.Result> shareCallback = new FacebookCallback<Sharer.Result>() {
        ...
        public void onSuccess(Sharer.Result result) {
            Log.d("FacebookFragment", "SuccessActivity!");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        ImageButton mFacebook = (ImageButton) v.findViewById(R.id.btn_custom_fb);
...
/* postStatusUpdateButton = (Button) v.findViewById(postStatusUpdateButton);
        ...
        postPhotoButton = (Button) v.findViewById(postPhotoButton);
    ...
    private void loginWithFacebook() {
        if(AccessToken.getCurrentAccessToken() != null && Profile.getCurrentProfile() != null) {
            ...
            LoginManager.getInstance().registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
                @Override
                public void onSuccess(LoginResult loginResult) {
                    //Toast.makeText(FacebookFragment.this, "onSuccess: " + loginResult.getAccessToken().getUserId(), Toast.LENGTH_SHORT).show();
                }
